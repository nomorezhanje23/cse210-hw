...
class Activity
{
    ...
    private string startingMessage,  description, activityName;
    ...
    {
        Console.Write("03 Nov 2022 {0} (30 min)- Distance 3.0 miles, Speed 6.0 mph, Pace: 10.0 min per mile", activityName);
    ...
    public void displayStartingMessage()
    {
        ...
        Console.WriteLine();
        Console.Write("How long, in seconds, would you like to exercise for? ");
