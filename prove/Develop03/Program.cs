...
class Program
{
    static void Main(string[] args)
    {
        ...
        Scripture scripture = new Scripture (scriptureReference, "Trust in the lord with all thine heart and lean not unto thine own understanding; in all ways acknwlwdge him and he shall direct thy paths.");
